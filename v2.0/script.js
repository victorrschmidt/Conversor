...
const base_conversao = {
    /*
        ...
        Ex: valor(em quilometros-hora) = 10; "quilometro-hora" para metro-segundo => (quilometro-hora /= 3.6) = valor(metro-segundo)
    */
        ...
        if(input.value != '') // Verificar se o input foi preenchido
        {
            ...
            {   
                ...
                case 'rankine':  // Caso específico (expressão)
                    ...
                    break;
                case 'newton':  // Caso específico (expressão com número irracional)
                    valor = valor*100/33;
                    break;
            ...
            switch(metodo_output)  // Verificar a escala de output e fazer a conversão
            {
                ...
                case 'rankine':  // Caso específico (expressão)
                    ...
                    break;
                case 'newton':  // Caso específico (esta expressão no switch anterior envolve um número irracional)
                    valor *= 0.33;
                    break;
