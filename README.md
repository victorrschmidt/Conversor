...
#### Notas:
- Foi adicionada a função de mudar o idioma do site (Idiomas atuais: português brasileiro e inglês). Os SVGs associados foram utilizados a partir do repositório https://github.com/lipis/flag-icons
